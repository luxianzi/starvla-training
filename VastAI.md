...
* Synchronizing Data with Amazon S3
  ...
  ID     NAME                Cloud Type
  34161  h10w-training-data  s3
  ```

  The number `34161` above is the `<Connection ID>`.
  ...
  ```
  vastai cloud copy --src /h10w-training-data/ --dst /home/worker/share --instance 28791005 --connection 34161 --transfer "Cloud To Instance"
  ```
